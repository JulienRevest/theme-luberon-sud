...
if ( apidae_has_( 'informationsHebergementLocatif.hebergementLocatifType' ) ) {
	...
	?>
		<h2><span class="icon-infos-logement" aria-hidden="true"></span><?php echo esc_html( $heading_info_logement ); ?></h2>
		<?php
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.capaciteMaximumPossible', null ) ) {
			...
			$html .= '<div><span class="icon-person" aria-hidden="true"></span><strong>' . esc_html( __( 'Capacité maximum possible', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreCabines', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-pillows" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de cabines', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreChambresEnMezzanine', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-pillows" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de chambres en mezzanine', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreLitsDoubles', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-double-bed" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de lits doubles', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreLitsSimples', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-single-bed" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de lits simples', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.surface', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-surface" aria-hidden="true"></span><strong>' . esc_html( __( 'Surface', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreSallesDeBain', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-bathroom" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de salles de bain', 'wp-apidae' ) ) . '</strong></div>';
			$html .= '<p>' . sprintf( _n( '%s salle de bain', '%s salles de bain', $nombre_salles_de_bain, 'wp-apidae' ), $nombre_salles_de_bain ) . '</p>';
			$html .= '</div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreWC', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-toilet" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de wc', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombrePieces', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-rooms" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre de pièces', 'wp-apidae' ) ) . '</strong></div>';
		...
		if ( apidae_has_( 'informationsHebergementLocatif.capacite.nombreEtages', null ) ) {
			$html  = '<div class="dae-single-infos-block">';
			$html .= '<div><span class="icon-stairs" aria-hidden="true"></span><strong>' . esc_html( __( 'Nombre d\'étages dans le bâtiment', 'wp-apidae' ) ) . '</strong></div>';
