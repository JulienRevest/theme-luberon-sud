	...
	<div class="dae-single-cols">
		<div class="dae-single-col-main">
			...
			<div class="dae-single-content">
				 ...
				 * Hook : For 3rd party.
				 */
				do_action( 'apidae_before_single_multimedia' );
				?>

				<?php
				/**
				 * Hook: apidae_single_multimedia
				 *
				 * @hooked apidae_template_single_multimedia - 10
				 */
				 ...
				 * Hook : For 3rd party.
				 */
				do_action( 'apidae_after_single_multimedia' );
				?>
			</div>
		</div>
